...
namespace Creator
{
    ...
    D3DContainer::D3DContainer(const D3DContainer &other)
    {
    }
    ...
    ID3D11Device *D3DContainer::GetDevice()
    {
        return m_device;
    }

    ID3D11DeviceContext *D3DContainer::GetDeviceContext()
    {
        return m_deviceContext;
    }

    void D3DContainer::GetProjectionMatrix(XMMATRIX &projectionMatrix)
    {
        projectionMatrix = m_projectionMatrix;
        return;
    }

    void D3DContainer::GetWorldMatrix(XMMATRIX &worldMatrix)
    {
        worldMatrix = m_worldMatrix;
        return;
    }

    void D3DContainer::GetOrthoMatrix(XMMATRIX &orthoMatrix)
    {
        orthoMatrix = m_orthoMatrix;
        return;
    }

    void D3DContainer::GetVideoCardInfo(char *cardName, int &memory)
    {
    ...
    void D3DContainer::SetBackBufferRenderTarget()
    {
        // Bind the render target view and depth stencil buffer to the output render pipeline.
        m_deviceContext->OMSetRenderTargets(1, &m_renderTargetView, m_depthStencilView);
    ...
    void D3DContainer::ResetViewport()
    {
        // Set the viewport.
        m_deviceContext->RSSetViewports(1, &m_viewport);
